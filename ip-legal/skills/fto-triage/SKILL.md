...
4. Run a preliminary patent search if a connector is available (Solve
   Intelligence, or other patent-research MCP). Otherwise say
...
> Intelligence, USPTO Patents Full-Text, EPO Espacenet,
...
triage did not hit Solve Intelligence, USPTO Patents Full-Text,
