...
jurisdictions/za/employment-legal/router.md and load the topic overlays and statute files listed for
the active skill.

**Shared company profile.** Company-level facts (who you are, what you do, where you operate, your risk posture, key people) live in `~/.claude/plugins/config/claude-for-legal/company-profile.md` — one level above this file, shared by all 12 plugins. Read it before this plugin's practice profile. If it doesn't exist, this plugin's setup will create it.
-->

# Employment Law Practice Profile — South Africa
...
- **No general protection for internal analyses.** Compliance assessments, disciplinary investigation reports, employment equity analyses, and workplace restructuring plans are generally not privileged unless prepared at the specific direction of a legal practitioner for the purpose of giving legal advice or in contemplation of litigation.
- **CCMA proceedings** — the CCMA is not a court but a statutory tribunal. Whether privilege applies to CCMA proceedings depends on the circumstances; however, the general position is that documents prepared for CCMA conciliation and arbitration may attract litigation privilege if litigation (including CCMA arbitration) was in contemplation at the time of preparation.

When the header says `PRIVILEGED & CONFIDENTIAL`, it is an assertion that the document was prepared in a legal capacity for the purpose of providing legal advice. If that is not accurate — if the document is a business analysis, an HR assessment, or a compliance review that happens to be written by a lawyer — the header does not create a privilege that doesn't exist. A false privilege claim is worse than no marking: it creates a false sense of security and may be challenged successfully in CCMA or Labour Court proceedings.
...
> "You mentioned that BCEA notice for employees with more than 1 year of service is 2 weeks — my understanding is it's 4 weeks (BCEA s37(1)(c)). Can you confirm which you meant? `[premise flagged — verify]`"
...
**Provinces with employees:** [PLACEHOLDER — e.g., Gauteng, Western Cape, KwaZulu-Natal]
**Sectoral determinations applicable:** [PLACEHOLDER — e.g., Hospitality (SD 14), Wholesale & Retail (SD 9), none]
**Bargaining council coverage:** [PLACEHOLDER — e.g., Metal and Engineering (MEIBC), Motor Industry (MIBCO), none]
**Primary office location:** [PLACEHOLDER]

**High-attention areas** (most employees, most CCMA exposure, or most complex bargaining council obligations):
- [PLACEHOLDER — e.g., Gauteng (head office, 60% of workforce), MEIBC-covered operations]
...
**When legal reviews terminations:** [PLACEHOLDER — all / performance only / retrenchments only / exec only]

**Standard severance (retrenchment only):** [PLACEHOLDER — statutory minimum (1 week per completed year of service per LRA s41(2)) / above statutory / formula]
**Release required for enhanced severance:** [PLACEHOLDER — Y/N, template location]
...
**BCEA earnings threshold classification:** [PLACEHOLDER — workforce breakdown above/below threshold]
**Ordinary hours of work:** [PLACEHOLDER — 45 hours per week (BCEA default) / reduced by agreement or sectoral determination]
**Overtime policy:** [PLACEHOLDER — permitted up to BCEA maximum of 10 hours per week / limited by agreement / not applicable (above threshold)]
**Contractor classification review:** [PLACEHOLDER — when, by whom, Code of Good Practice: Who Is an Employee (s200A presumption)]
**Known classification risk areas:** [PLACEHOLDER — roles where s200A presumption of employment may apply]

---

## Handbook / disciplinary code

**Disciplinary code and procedure:** [PLACEHOLDER — location, date of last update]
**Grievance procedure:** [PLACEHOLDER — location, date of last update]
**Update cadence:** [PLACEHOLDER]
**SA policy conventions included:** [PLACEHOLDER — e.g., sexual harassment policy (Code of Good Practice), substance abuse policy, social media policy, IT usage policy]

---

## Dispute resolution

**Primary dispute resolution forum:** [PLACEHOLDER — CCMA / bargaining council (specify which)]
**Bargaining council with jurisdiction:** [PLACEHOLDER — council name, or "none — CCMA is primary forum"]
**Recognised trade union(s):** [PLACEHOLDER — union name(s), recognition agreement Y/N, majority union status]
**External labour consultants used:** [PLACEHOLDER — firm name / none / only for retrenchments]
**Preferred approach to CCMA conciliation:** [PLACEHOLDER — settle where reasonable / defend robustly / case-by-case]

---

## Leave and conditions

**Leave cycle:** [PLACEHOLDER — January–December / anniversary-based / other]
**Annual leave:** [PLACEHOLDER — BCEA minimum (21 consecutive days or 15 working days per cycle) / above minimum (specify)]
**Sick leave:** [PLACEHOLDER — BCEA minimum (30 days over 3-year cycle) / above minimum (specify)]
**Maternity leave:** [PLACEHOLDER — BCEA minimum (4 consecutive months unpaid) / enhanced (specify — e.g., paid maternity, duration)]
**Maternity pay source:** [PLACEHOLDER — UIF only / employer tops up UIF / employer pays full salary]
**Family responsibility leave:** [PLACEHOLDER — BCEA minimum (3 days per year) / above minimum]
**Parental leave (Labour Laws Amendment Act):** [PLACEHOLDER — 10 consecutive days / enhanced]
**Other leave types:** [PLACEHOLDER — e.g., study leave, religious observance leave, additional compassionate leave]

---

## Retrenchment

**s189A applicability:** [PLACEHOLDER — employer has 50+ employees and thresholds may apply / employer has fewer than 50 employees / unknown]
**Consultation preference:** [PLACEHOLDER — internal consultation led by management / facilitated consultation via CCMA / external labour consultant leads process]
**Selection criteria default:** [PLACEHOLDER — LIFO / skills-based / hybrid / not yet established]
**Severance package approach:** [PLACEHOLDER — statutory minimum only / enhanced package (specify multiplier or formula)]
**Outplacement support:** [PLACEHOLDER — provided / not provided / case-by-case]
...
|---|---|---|---|
| Routine offer letter | [HR] | [You] | Restraint of trade, exec, new province |
| Performance termination | [HR + you] | [GC / Senior Partner] | High-risk flags present (see dismissal.md) |
| Retrenchment (below s189A) | [HR + you] | [GC] | Any retrenchment |
| Retrenchment (s189A territory) | — | [GC + outside counsel] | Always |
| CCMA referral received | — | [GC immediately] | Always |
| Labour Court application | — | [GC + outside counsel] | Always |
| Bargaining council dispute | — | [GC / labour consultant] | Always |
| EE compliance query from DoEL | — | [GC immediately] | Always |
| Strike / protected action notice | — | [GC + outside counsel] | Always |
...
**Disciplinary code location:** [Drive folder / SharePoint / local path]
**Employment contract templates location:** [Drive folder / SharePoint / local path]
...
|---|---|---|---|
| Disciplinary code & procedure | [PLACEHOLDER] | | |
| Standard employment contract template | [PLACEHOLDER] | | |
| CCMA outcome / award 1 (optional) | [PLACEHOLDER] | | Past CCMA matters for pattern reference |
| CCMA outcome / award 2 (optional) | [PLACEHOLDER] | | |
| Employment equity plan (optional) | [PLACEHOLDER] | | Current EE plan if designated employer |
| Retrenchment consultation template (optional) | [PLACEHOLDER] | | s189 notice template if available |
